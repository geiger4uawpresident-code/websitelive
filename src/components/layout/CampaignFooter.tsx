...
import { Facebook, Youtube, Instagram, Twitter, Mail, ShieldCheck } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#endorsements" className="text-white/80 hover:text-white transition-colors">Endorsements</a></li>
